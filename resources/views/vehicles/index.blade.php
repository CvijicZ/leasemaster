...
@section('admin-content')
    <style>
        .status-badge {
            ...
            /* Rounded corner for the top-right */
        }
    </style>
    <div class="container-fluid">
        ...
        <div class="row">
            @forelse ($vehicles as $vehicle)
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 vehicle-card" data-status="{{ $vehicle->status }}"
                    ...
                    <div class="card shadow-sm bg-custom text-custom-secondary h-100">
                        ...
                        <div class="position-relative">
                            ...
                            <img src="{{ $vehicle->images->first() ? asset('storage/' . $vehicle->images->first()->path) : asset('images/no-image-available.jpg') }}"
                                class="card-img-top" alt="{{ $vehicle->make . ' ' . $vehicle->model }}"
                                style="height: 200px; object-fit: cover;">

                            <!-- Status badge overlay -->
                            <span
                                class="status-badge position-absolute top-0 end-0 badge 
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text">
                                @if ($vehicle->user)
                                    ...
                                    <strong>Rental Period:</strong> <i class="fa-solid fa-calendar-days"></i>
                                    {{ $vehicle->contract_created_at }}
                        ...
                        ">
                            ...
                            <div class="mt-auto mx-auto">
                                ...
                                @if ($vehicle->contract_id)
                                    <a href="{{ route('admin.contract.show', $vehicle->contract_id) }}"
